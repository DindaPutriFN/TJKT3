...
Servo myServo;
LiquidCrystal_I2C lcd(0x27, 16, 2);  // Alamat I2C default, bisa diubah sesuai hasil I2C Scanner
...
void loop() {
  ...
  lcd.setCursor(0, 1);  // Kembali ke posisi awal baris kedua
  lcd.print(distance);  // Cetak jarak
  lcd.print(" cm");
  ...
  delay(0);  // Delay untuk memperlambat pembacaan
}